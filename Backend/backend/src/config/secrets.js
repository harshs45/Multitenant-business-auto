...
module.exports = {
  ...
  openaiApiKey: () => get('OPENAI_KEY', get('OPENAI_API_KEY', '')),
  openaiModel: () => get('OPENAI_MODEL', 'gpt-4o-mini'),
  anthropicApiKey: () => get('ANTHROPIC_KEY', get('ANTHROPIC_API_KEY', '')),
  anthropicModel: () => get('ANTHROPIC_MODEL', 'claude-3-haiku-20240307'),
  geminiApiKey: () => get('GEMINI_KEY', get('GEMINI_API_KEY', '')),
  geminiModel: () => get('GEMINI_MODEL', 'gemini-2.0-flash'),
  ollamaHost: () => get('OLLAMA_HOST', 'http://localhost:11434'),
  ollamaModel: () => get('OLLAMA_MODEL', 'llama3'),
  llmProvider,
