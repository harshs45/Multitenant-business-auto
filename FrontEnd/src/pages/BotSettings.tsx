      ...
      try {
        ...
        if (res.success) {
          ...
          setFormData({
            ...
            welcomeMessage:
              res.data.welcomeMessage || "Hello! How can I help you today?",
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-background border border-border rounded-2xl shadow-sm overflow-hidden">
          <form onSubmit={handleSubmit}>
                ...
                <section className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full h-11 px-4 bg-transparent border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium"
                      placeholder="e.g. SalesHelper"
                    />
                    <p className="text-[10px] text-muted-foreground">
                      The internal name used to identify this bot instance.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full p-4 bg-transparent border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium resize-none"
                ...
                <section className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full h-11 px-4 bg-transparent border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium capitalize"
                    >
                      {TONES.map((t) => (
                        <option
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <select
                        ...
                        className="w-full h-11 pl-10 pr-4 bg-transparent border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium"
                      >
                        {LANGUAGES.map((l) => (
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-[10px] text-muted-foreground">
                      Used for lead notifications and human handoff requests.
                    </p>
                  </div>
                </section>
              </div>
            ...
            {/* Form Footer */}
            <div className="bg-transparent border-t border-border p-6 flex items-center justify-end">
              <button
                type="submit"
                disabled={saving}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        disabled={
                          isDeleting ||
                          deleteConfirmName !== (bot?.botName || bot?.name)
                        }
